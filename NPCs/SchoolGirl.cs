...
namespace BounceBack.NPCs
{
	...
	[AutoloadHead]
	public class SchoolGirl : ModNPC
	{
		public override string Texture => "BounceBack/NPCs/SchoolGirl";
		...
		public override void SetStaticDefaults() {
			...
			DisplayName.SetDefault("School Girl");
		...
		public override bool CanTownNPCSpawn(int numTownNPCs, int money)
		{
			for (int k = 0; k < 255; k++) {
				...
				foreach (Item item in player.inventory) {
					if (item.type == ModContent.ItemType<SneakyBoulder>()) {
						return true;
					}
				}
			}
		...
		public override string GetChat() {
			...
			if (PartyGirl >= 0 && Main.rand.NextBool(4)) {
				return "Not a lot of people here enjoy fun. You and " + Main.npc[PartyGirl].GivenName + " are the only ones who get me.";
			} 
			switch (Main.rand.Next(4)) {
				case 0:
					return "GACHAAA!";
				case 1:
					return "Just 500 more pulls... Then I'll quit, I SWEAR!";
				case 2:
					{
					return "I need all 8 pieces to the sad shiba inu set. Then I can assemble Exodia.";
					}
				default:
					return "Don't worry. All the money you give me goes to good use. I invest it in gacha-ing new oufits for my augmented reality girlfriend.";
			}
		}
		...
		*/
		...
		public override void SetupShop(Chest shop, ref int nextSlot) {
			shop.item[nextSlot].SetDefaults(ModContent.ItemType<GachaponStar>());
			nextSlot++;
			if (NPC.downedBoss2) {
				shop.item[nextSlot].SetDefaults(ModContent.ItemType<GachaponHeart>());
				nextSlot++;
			}
			if (NPC.downedBoss3) {
				shop.item[nextSlot].SetDefaults(ModContent.ItemType<GachaponMoon>());
				nextSlot++;
			}
			shop.item[nextSlot].SetDefaults(ModContent.ItemType<RubberBand>());
			nextSlot++;
		...
		public override void TownNPCAttackProj(ref int projType, ref int attackDelay) {
			projType = ModContent.ProjectileType<PencilProj>();
			attackDelay = 1;
		}
