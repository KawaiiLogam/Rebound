...
{
	public class MetalBallBearing : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Metal Ball Bearing");
			Tooltip.SetDefault("Used to make bouncy balls");
		}
		...
		public override void SetDefaults() {
			...
			recipe.SetResult(this, 1); // or, for a vanilla result, recipe.SetResult(ItemID.Muramasa);
			// Finish your recipe
			recipe.AddRecipe();
        }	
	}
