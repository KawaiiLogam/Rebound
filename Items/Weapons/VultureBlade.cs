...
{
	public class VultureBlade : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Vulture Blade");
			Tooltip.SetDefault("The scavenger of swords");  //The (English) text shown below your weapon's name
		}
		...
		public override void SetDefaults() {
			...
			item.value = Item.sellPrice(silver: 20); // The value of the weapon in copper coins
			item.rare = ItemRarityID.Blue; // The rarity of the weapon, from -1 to 13. You can also use ItemRarityID.TheColorRarity
