...
{
	public class Cosmo : ResilienceDamage
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Cosmo");
			Tooltip.SetDefault("Now battle the Mawgu");
		}
		public override void SafeSetDefaults() {
			...
			item.useAnimation = 70; // The length of the item's use animation in ticks (60 ticks == 1 second.)
