...
{
	public class BoundiumBlade : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Boundium Blade");
		...
		public override void SetDefaults() {
			...
			item.useTime = 21; // The time span of using the weapon. Remember in terraria, 60 frames is a second.
			item.useAnimation = 20; // The time span of the using animation of the weapon, suggest setting it the same as useTime.
			item.knockBack = 4; // The force of knockback of the weapon. Maximum is 20
			item.value = Item.sellPrice(gold: 1); // The value of the weapon in copper coins
        ...
        public override void AddRecipes() {
			ModRecipe recipe = new ModRecipe(mod);
			recipe.AddIngredient(ModContent.ItemType<BoundiumBar>(), 14);
