...
namespace BounceBack.Projectiles
{
	public class GelBallProj : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Gel Ball");
		...
		public override void Kill(int timeLeft)
		{
			...
			Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, ModContent.ItemType<GelBall>(), 1, false, 0, false, false);
