...
{
	public class PinkGelBallProj : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, ModContent.ItemType<PinkGelBall>(), 1, false, 0, false, false);
